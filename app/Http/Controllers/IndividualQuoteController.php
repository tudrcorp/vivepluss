...
use App\Models\User;
use App\Services\IndividualQuotePdfBuilder;
...
class IndividualQuoteController extends Controller
{
    ...
    public static function generatePdfPlanIncial($details, $user)
    {
        try {
            ...
            (new IndividualQuotePdfBuilder)->build(compact('details', 'collect', 'name_user'), static::quotePdfPath($name_pdf));
    ...
    public static function generatePdfPlanIdeal($details, $user)
    {
        try {
            ...
            $name_user = $user->name;
            $name_pdf = $details['code'].'.pdf';
            (new IndividualQuotePdfBuilder)->build(compact('details', 'group_collect', 'name_user'), static::quotePdfPath($name_pdf));
