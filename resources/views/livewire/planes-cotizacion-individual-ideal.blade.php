...
<body>
    ...
    <div class="cover" style="background-color: white;">
        ...
        <div style="position: absolute; top: 200px; left: 40px; width: 700px; max-width: 700px; font-family: 'quicksand', sans-serif;">
            @livewire('tabla-beneficio-cobertura', ['id' => 2])
        </div>
        ...
        <div style="position: absolute; top: 500px; right: 10px; margin-top: 20px; padding: 20px; margin-right: 20px; width: 700px;">
            <table style="width: 100%; font-type: Helvetica, sans-serif;">
                <tr style="background-color: {{ $setting->infoColor }}; font-size: 10px;">
                    ...
                    <th style="font-weight: bold; color: white;">TARIFA ANUAL<br>{{ $coverageCurrency }} 1K</th>
                    <th style="font-weight: bold; color: white;">TARIFA ANUAL<br>{{ $coverageCurrency }} 2K</th>
                    <th style="font-weight: bold; color: white;">TARIFA ANUAL<br>{{ $coverageCurrency }} 3K</th>
            ...
            <table style="width: 100%; border-collapse: collapse; font-type: Helvetica, sans-serif;">
                <tbody>
                    <tr>
                        <td colspan="3" style="font-weight: bold; color: white; font-size: 10px; width: 88px; background-color: {{ $setting->infoColor }};">TARIFA GRUPAL ANUAL</td>
                    ...
                    <tr>
                        <td colspan="3" style="font-weight: bold; color: white; font-size: 10px; width: 88px; background-color: {{ $setting->infoColor }};">TARIFA GRUPAL SEMESTRAL</td>
                    ...
                    <tr>
                        <td colspan="3" style="font-weight: bold; color: white; font-size: 10px; width: 88px; background-color: {{ $setting->infoColor }};">TARIFA GRUPAL TRIMESTRAL</td>
